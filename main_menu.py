...
#สีพื้นหลังเริ่มต้น หมุนเฉดสีพื้นหลังเพื่อให้ค่อยๆเปลี่ยนสี ตำแหน่งของเฉดสีหรือค่าการเปลี่ยนสีในแต่ละเฟรม
color_shift = 0 
...
#ไล่สีแบบไปกลับ: จากแดง เหลือง เขียว ฟ้า น้ำเงิน ม่วง กลับมาแดง
    if color_shift < 255:
        r = 255
        g = color_shift
        b = 0
    ...
    color1 = (r // 2, g // 2, b // 2)  #สีเข้มสำหรับด้านบน ค่าสีเข้มขึ้นครึ่งหนึ่ง
    color2 = (r, g, b)                 #สีสดสำหรับด้านล่าง ค่าสีเต็ม
 
 #วาดพื้นหลังแบบไล่สี (gradient)
    for y in range(1280):  #วนลูป y จาก 0 ถึง 719 (เพราะจอมีความสูง 720 พิกเซล)แต่ละค่า y คือ “ตำแหน่งแนวตั้ง” ของหน้าจอ
        ratio = y / 1280  #อัตราส่วนการผสมสี ตอนนี้เราอยู่ระหว่างสีบนกับสีล่างมากแค่ไหน
